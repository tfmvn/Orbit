# @orbit/memory (reserved)

This package is a placeholder. It is not implemented in the foundation
phase of Orbit.

## Future purpose
Memory — persists and retrieves agent state/context across jobs (short-term and long-term memory). Implements the `MemoryProvider` interface defined in `apps/api/src/orbit_api/interfaces/memory.py`.
